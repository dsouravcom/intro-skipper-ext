(function () {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // Crunchyroll intro / credits / preview skipper
    //
    ...
    function watchSettings() {
        // Settings live in chrome.storage.sync; react to any change so toggles
    ...
    async function fetchSkipEvents(id) {
        // Prefer the background worker (bypasses CORS via host permissions);
        ...
        try {
            ...
            // Background unavailable (e.g. worker asleep) — fall through.
        }
        try {
